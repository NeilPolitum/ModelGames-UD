...
<%  ScoreDataBase db = new ScoreDataBase();
    ResultSet res = db.obtener_puntaje("La Llorona");
    ResultSet res2 = db.obtener_puntaje_individual("La Llorona",request.getParameter("user_login"));
    int contador = 0;
%>
<!DOCTYPE html>
<html lang="es">
	<head>
		...
		<link rel="stylesheet" type="text/css" href="Juegos/Llorona/estilosLlorona/default.css" media="screen">
		<script src="Juegos/Llorona/jsLlorona/jquery-1.11.0.min.js" language="JavaScript1.2"></script>
		<script src="Juegos/Llorona/jsLlorona/quica.js" language="JavaScript1.2"></script>
		<script src="Juegos/Llorona/jsLlorona/calaca.js" language="JavaScript1.2"></script>
		<script src="Juegos/Llorona/jsLlorona/script.js" language="JavaScript1.2"></script>
	...
	<body>
		...
		<section>
			<div id="popup" style="display: none;">
				<div class="content-popup">
					<div class="close"><a href="#" id="close"><img src="Juegos/Llorona/imagenesLlorona/close.png"/></a></div>
					<div>
					   <h2>Teclas de juego</h2>
					   <img src="Juegos/Llorona/imagenesLlorona/teclado.png"/>
					   <h2>Creditos</h2>
			...
			<button id="iniciar">Iniciar</button>
                        <form action="GuardarPuntuacion" method="post">
                            ...
                            <input type="hidden" id="juego" name="juego" value="La Llorona"></input>
		...
		<audio id="pierde">
			<source src="Juegos/Llorona/sonidosLlorona/pierde_vida.ogg" type="audio/ogg">
			<source src="Juegos/Llorona/sonidosLlorona/pierde_vida.mp3" type="audio/mpeg">
			<source src="Juegos/Llorona/sonidosLlorona/pierde_vida.wav" type="audio/wav">
			Tu navegador no es compatible
		</audio>
		
		<img id="abajo" src="Juegos/Llorona/imagenesLlorona/kika.png"/>
		<img id="arriba" src="Juegos/Llorona/imagenesLlorona/kika2.png"/>
		<img id="salto" src="Juegos/Llorona/imagenesLlorona/kika.png"/>
		<img id="sentado" src="Juegos/Llorona/imagenesLlorona/kika3.png"/>
		<img id="calaca_1" src="Juegos/Llorona/imagenesLlorona/calaca_child.png"/>
		<img id="calaca_2" src="Juegos/Llorona/imagenesLlorona/calaca_girl.png"/>
	</body>
</html>

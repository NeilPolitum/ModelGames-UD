...
var Juego = {    
    ...
    preload: function(){
        ...
        juego.load.image('fondo', 'Juegos/Saltarin/img/img_j1/giphy.jpg');
        juego.load.image('personaje', 'Juegos/Saltarin/img/img_j1/personaje1.png');
        juego.load.image('obstaculo', 'Juegos/Saltarin/img/img_j1/obstaculo.png');
